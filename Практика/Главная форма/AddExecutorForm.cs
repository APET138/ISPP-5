...
namespace Бюро_технической_инвентаризации
{
    public partial class AddExecutorForm : Form
    {
        ...
        private void ConfirmButtonExec_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd;
            string querystring = $"insert into Executors(FamName, Name, Surname) values('{fam}', '{name}', '{surname}')";
        ...
        private void CancelButtonExec_Click(object sender, EventArgs e)
        {
            this.Close();
        }
    }
