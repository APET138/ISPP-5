...
namespace Бюро_технической_инвентаризации
{
    ...
    {
        public EditExecutorForm()
        {
            InitializeComponent();
        }

        private void ConfirmButtonEditExec_Click(object sender, EventArgs e)
        {
            ...
            string updatestring = $"UPDATE Executors SET FamName = '{fanam}', Name = '{name}', Surname = '{surname}' WHERE Executor_Code = '{id}'";
        ...
        private void CancelButtonEditExec_Click(object sender, EventArgs e)
        {
            this.Close();
        }
    }
